...
export const paymentApi = {
  ...
  async createOrder(input: PaymentOrderRequest): Promise<PaymentOrderResponse> {
...
export const learningApi = {
  ...
  async submitLessonQuiz(attemptId: string, answers: Array<{ questionId: string; selectedAnswerId: string }>, durationSeconds: number): Promise<QuizSubmitResultDto> {
